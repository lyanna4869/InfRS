...
if __name__ == '__main__':
    ...
    if len(args) == 0:
        ...
        args = [
            "--src1", "weights/DIOR_R101_split1.pth",
            "--method", "randinit", 
            "--save-dir", "work_dirs/dior_resnet101_base1_all_redetect/"
        ]
        args = [
           "--src1", "weights/DIOR_R101_split2.pth",
           "--method", "randinit", 
           "--save-dir", "work_dirs/dior_resnet101_base2_all_redetect/"
        ]
        args = [
            "--src1", "weights/DIOR_R101_split3.pth",
            "--method", "randinit", 
            "--save-dir", "work_dirs/dior_resnet101_base3_all_redetect/"
        ]
