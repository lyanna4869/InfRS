...
if __name__ == '__main__':
    ...
    if len(args) == 0:
        ...
        # args = [
        #    "--src1", "weights/NWPU_R101_split2.pth",
        #    "--method", "randinit", 
        #    "--save-dir", "work_dirs/nwpu_resnet101_base2_all_redetect/"
        # ]
        args = [
            "--src1", "weights/NWPU_R101_split3.pth",
            "--method", "randinit", 
            "--save-dir", "work_dirs/nwpu_resnet101_base3_all_redetect/"
        ]
