...
def test():
    ...
    fileloc = "checkpoints/nwpu/prototype/select_shot/results.feature"
...
BASE_DIR = osp.join(DATASETS_PATH, "NWPU")
...
if __name__ == "__main__":    
    ...
    args = sys.argv[1:]
    if len(args) == 0:
        args = ["--cluster", "5", "--inherit", "datasets/NWPU/compare_imageset_3"]
    main(args)