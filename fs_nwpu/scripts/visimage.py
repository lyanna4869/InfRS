...
from fs_nwpu.core.meta import ALL_CATEGORIES
VOC_CLASSES = ALL_CATEGORIES[1]
from fs_nwpu.core.category import CLASS_COLOR
...
def main(args = None):
    ...
    parser.add_argument("--src", type=str, default="/home/lwz/prj/fsce/checkpoints/nwpu/split1_fpn/10shot_inc_clp", help="classification txt")
    parser.add_argument("--image", type=str, default="/home/lwz/prj/fsce/datasets/NWPU/JPEGImages", help="classification txt")
    ...
    # visualizer = ResultViser("checkpoints/fs/pascal_voc_eval(cpe)", "datasets/NWPU/Images")
    # visualizer.output("checkpoints/results/nwpu/res101_10shot_cpe1")
