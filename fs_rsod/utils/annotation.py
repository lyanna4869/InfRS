...
from fs.data.loader import VocDataset 
from fs_rsod.core.category import ORIGINAL_CLASS_NAMES as RSOD_CLASSES

class RsodDataset(VocDataset):
    CLASS_NAMES = RSOD_CLASSES
...
classMap = {idx+1: name for idx, name in enumerate(RSOD_CLASSES)}
...
def parse_rsod_annotations(filenames=None):
        ...
        with open(file_loc, "r") as f:
            for line in f:
                ...
                insdict = {
                    ...
                    "oid": object_id,
                    "name": RSOD_CLASSES[int(data[4])-1],
                    "image_id": file_name
                }
                object_id += 1
