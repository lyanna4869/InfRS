...
_C.INPUT.KEEP_INSTANCE_AREA = False
...
_C.MODEL.ROI_HEADS.FREEZE_PRED = False
_C.MODEL.ROI_HEADS.FREEZE_REDETECT = False
...
_C.MODEL.ROI_HEADS.BASEDET_BONUS = 0.1
_C.MODEL.ROI_HEADS.COEFF = 0.1


# scale of cosine similarity (set to -1 for learnable scale)
_C.MODEL.ROI_HEADS.COSINE_ON = True
_C.MODEL.ROI_HEADS.COSINE_SCALE = 10.0
_C.MODEL.ROI_HEADS.COSINE_MARGIN = 0.35
_C.MODEL.ROI_HEADS.OUTPUT_CLS = "FastRCNNOutputs"
...
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.LOSS_START = 200
...
### KL  bsf.c 230829.14
_C.MODEL.ROI_BOX_HEAD.REDETECT = CN()  # use with ContrastiveROIHeadsWithPrototype
_C.MODEL.ROI_BOX_HEAD.REDETECT.LOSS = "KL"

### PROTOTYPE bsf.c 230829.14
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE = CN()  # use with ContrastiveROIHeadsWithPrototype
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.ENABLED = False
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.SAMPLE = False
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.MAX_INS_COUNT_PER_CATEGORY = -1

_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.DATASET = 'PASCAL VOC'
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.PATH = ''
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.DISABLE_PROTOTYPE_GRAD = True
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.NUM_FC = 2
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.FC_DIM = 1024
# Hidden layer dimension for FC layers in the RoI box head
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.NUM_CONV = 0
# Channel dimension for Conv layers in the RoI box head
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.CONV_DIM = 256
# Normalization method for the convolution layers.
# Options: "" (no norm), "GN", "SyncBN".
_C.MODEL.ROI_BOX_HEAD.PROTOTYPE.NORM = ""

# train the contrastive head only
_C.MODEL.ROI_BOX_HEAD.CONTRASTIVE_BRANCH.HEAD_ONLY = False
_C.MODEL.ROI_BOX_HEAD.MULTI_SIMILARITY_LOSS = CN()
_C.MODEL.ROI_BOX_HEAD.MULTI_SIMILARITY_LOSS.SCALE_POS = 2.0
_C.MODEL.ROI_BOX_HEAD.MULTI_SIMILARITY_LOSS.SCALE_NEG = 50.0
_C.MODEL.ROI_BOX_HEAD.MULTI_SIMILARITY_LOSS.LAMBDA = 0.5
...
_C.SOLVER.TEST_IMS_PER_BATCH = 4
