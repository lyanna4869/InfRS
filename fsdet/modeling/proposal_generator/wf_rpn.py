...
from fsdet.modeling.anchor_generator import build_anchor_generator
from fsdet.modeling.box_regression import Box2BoxTransform
from fsdet.modeling.matcher import Matcher
from fsdet.modeling.proposal_generator.rpn import RPN_HEAD_REGISTRY, RPN, StandardRPNHead

@RPN_HEAD_REGISTRY.register()
class WF_RPNHead(StandardRPNHead):
    def __init__(self, cfg, input_shape):
        ...
        for p in self.objectness_logits.parameters():
